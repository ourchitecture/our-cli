...
@ourchitecture/our-cli/0.0.2-alpha.2 win32-x64 node-v10.15.3
$ our --help [COMMAND]
USAGE
  $ our COMMAND
...
...
_See code: [src\commands\hello.ts](https://github.com/ourchitecture/our-cli/blob/v0.0.2-alpha.2/src\commands\hello.ts)_
